...
lambda.c = seq(0.13, 0.33, length = 11)
...
save(S.list, Omega.lg.list, Omega.rf.list, FDR, power, edge, overlap.edge, time, time.overall, record.list, time.list, file = "TVGM-SIMU-100-sparse.RData")
...
save(result, cv, time.overall, file = "TVGM-SIMU-CV-100-sparse.RData")